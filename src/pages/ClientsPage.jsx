    ...
    <div className="space-y-6">
      ...
      {selectedClient ? (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100">
          <div className="px-4 py-3 md:px-6 md:py-4 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center">
              <button
                onClick={handleCloseHistory}
                className="mr-4 text-gray-500 hover:text-gray-700 text-sm"
              >
                ← Back to clients
              </button>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {clientAppointments.length === 0 ? (
                    <tr>
                      <td colSpan="4" className="px-4 py-3 md:px-6 md:py-4 text-center text-gray-500">
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th scope="col" className="px-4 py-3 md:px-6 md:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Contact</th>
                    <th scope="col" className="px-4 py-3 md:px-6 md:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Notes</th>
                  ...
                  {filteredClients.length === 0 ? (
                    ...
                    filteredClients.map((client) => (
                      ...
                      >
                        <td className="px-4 py-3 md:px-6 md:py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="flex-shrink-0 h-8 w-8 md:h-10 md:w-10 bg-gradient-to-r from-amber-500 to-amber-700 rounded-full flex items-center justify-center">
                              <UserIcon className="h-4 w-4 md:h-6 md:w-6 text-white" />
                            </div>
                            <div className="ml-3 md:ml-4">
                              <div className="text-sm font-medium text-gray-900">{client.name}</div>
                              <div className="text-xs md:text-sm text-gray-500">Client since {client.createdAt?.toDate().toLocaleDateString()}</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-4 py-3 md:px-6 md:py-4 whitespace-nowrap">
